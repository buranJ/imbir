            ...
            <div className="feedback__content">
                <div className="feedback__top">
                    <div className="feedback__top-top">
                        <button className="feedback__btn"><img src={arrow} alt="arrow" className="feedback__btn-img" /></button>
                        <h2 className="feedback__top-title">Отзывы</h2>
                         <button className="feedback__btn"><img src={search} alt="search" className="feedback__btn-img" /></button>
                        <form action="">
